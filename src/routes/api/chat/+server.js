...
import { PhilosopherSkepticHelperOrchestrator } from '$lib/orchestrators/PhilosopherSkepticHelperOrchestrator.js';
...
export async function POST({ request }) {
  ...
  try {
    const orchestrator = new PhilosopherSkepticHelperOrchestrator();
